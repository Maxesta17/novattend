...
export default function Avatar({
  ...
  const sizes = {
    sm: 'size-[30px] min-w-[30px] rounded-md text-[10px]',
    md: 'size-[38px] min-w-[38px] rounded-[9px] text-xs',
    lg: 'size-14 min-w-14 rounded-xl text-xl',
  }

  const variants = {
    active: 'bg-burgundy text-white font-cinzel font-bold text-base',
